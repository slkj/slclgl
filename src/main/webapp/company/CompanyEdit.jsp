	...
	<form id="comForm">
		...
		<table class="grid">
			...
			<tr>
				...
				<td colspan="3">
					<input name="compName" class="easyui-textbox" data-options="required:'true'" style="width: 330px">
				</td>
			</tr>
			<tr>
				<th>简称：</th>
				<td><input name="compSName" class="easyui-textbox" data-options="required:'true'" style="width: 200px"></td>
				<th>组织机构代码：</th>
				<td><input name="organizationCode" class="easyui-textbox" style="width: 200px"/></td>
			</tr>
			<tr>
				<th>法人：</th>
			...
			<tr>
				<th>营业执照号：</th>
				<td><input name="businessLicense" class="easyui-textbox" style="width: 200px"></td>
				<th>注册资金：</th>
				<td><input name="registeredCapital" class="easyui-textbox" style="width: 200px">万元</td>
			</tr>
			<tr>
				<th>公司地址：</th>
				<td colspan="3"><input name="compAddress" class="easyui-textbox" style="width: 330px"></td>
			</tr>
			<tr>
				<th>简介</th>
