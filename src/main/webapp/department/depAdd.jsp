	...
	<form id="dform">
		<table class="grid" style="width: 100%">
			<tr>
				...
				<th>部门名称：</th>
				<td><input name="d_name" class="easyui-textbox"
			...
			<tr>
				...
				<td><input class="easyui-textbox"
					...
					style="width: 80%"></td>
				<th>传真：</th>
				<td><input name="d_fax" class="easyui-textbox" type="text"
					style="width: 80%"></td>
			</tr>
			<tr>
				<th>地址：</th>
				<td colspan="3"><input name="d_add" class="easyui-textbox"
					style="width: 80%"></td>
			</tr>
			<tr>
				<th>描述：</th>
				<td colspan="3"><input name="d_miaoshu" class="easyui-textbox"
					style="width: 80%"></td>
			</tr>
		</table>
