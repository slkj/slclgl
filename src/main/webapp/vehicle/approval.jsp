	...
	<div data-options="region:'north'" style="height: 40px">
		<ul>
			<li style="float: left;"><a href="javascript:void(0)"
				class="easyui-linkbutton" onclick="javascript:backPage()">入网</a></li>
			<li style="float: left;"><a href="javascript:void(0)"
				class="easyui-linkbutton" onclick="javascript:backPage()">返回</a></li>
		</ul>
	...
	<div data-options="region:'center'">
		<form id="carForm" metdod="post">
			<div id="aa" class="easyui-accordion" data-options="border:false">
				...
				<div title="车辆其他信息(*选填项，点击展开选项)" data-options="border:false">
					<table class="grid">
						<tr>
							...
							<td style="width: 290px"><input id="carEngNum"
								name="carEngNum" class="easyui-validatebox"
								style="width: 200px;" /></td>
						</tr>
						...
						<tr>
							...
							<td>长<input id="carContLength" name="carContLength"
								...
								name="carContWidth" class="easyui-numberbox"
								style="width: 70px;" data-options="min:0,precision:0" /> 高<input
								id="carContHeight" name="carContHeight" class="easyui-numberbox"
