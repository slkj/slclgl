...
<body>
		...
		<div id="aa" class="easyui-accordion" data-options="border:false">
			<div title="车辆基本信息" data-options="collapsed:false,collapsible:false,border:false"
				...
				<table  >
					...
					<tr>
						...
						<th>所属公司：</th>
						<td><input id="ownedId" name="ownedId" style="width: 200px;"
					...
					<tr>
						...
						<td><input id="ownedId" name="ownedId" style="width: 200px;"
							data-options="required:true" /></td>
						<th>车牌颜色：</th>
						<td><select  id="selCarType" name="selCarType" class="easyui-combobox"
					...
					<tr>
						...
						<td><select class="easyui-combobox" id="classify" name="classify"
							...
							style="width: 150px;"
							data-options="url:'carcalss_data.json',required:true,lines:true,panelHeight:300,panelWidth:200"></select>
						</td>
						<th>车辆品牌：</th>
			...
			<div title="设备信息" data-options="collapsed:false,collapsible:false,border:false">
				<table >
					<tr>
						<th>安装人:</th>
						<td><input name="regCompanyName" class="easyui-validatebox" data-options="required:true" style="width: 200px;" /></td>
						<th>服务人员：</th>
						<td><input id="regNum" name="regNum" class="easyui-validatebox" style="width: 200px;" /></td>
					</tr>
					<tr>
						<th>安装日期:</th>
						<td><input name="regCompanyName" class="easyui-datebox" data-options="required:true" style="width: 200px;" /></td>
						<th>安装地点：</th>
						<td><input id="regNum" name="regNum" class="easyui-validatebox" style="width: 200px;" /></td>
					</tr>
				</table>
			...
			<div title="服务信息" data-options="collapsed:false,collapsible:false,border:false">
				<table >
					<tr>
						<th>服务费 :</th>
						<td><input name="regCompanyName" class="easyui-validatebox" style="width: 200px;" /> (元/月)</td>
						<th>服务到期时间：</th>
						<td><input id="regNum" name="regNum" class="easyui-datebox" style="width: 150px;"/> 
							<label><input id="ckISnotice" type="checkbox" name="ckISnotice">到期提醒</label>
						</td>
					</tr>
					<tr>
						<th>SIM卡缴费人 :</th>
						<td><input name="regCompanyName" class="easyui-validatebox" style="width: 200px;" /></td>
						<th>缴费时间：</th>
						<td><input id="regNum" name="regNum" class="easyui-datebox" style="width: 150px;" />  
						</td>
					</tr>
			...
			<div title="行业信息" data-options="collapsed:false,collapsible:false,border:false">
				<table >
					<tr>
						...
						<td><input name="regCompanyName" class="easyui-validatebox"  style="width: 200px;" /></td>
						<th>载客数：</th>
						<td><input id="regNum" name="regNum"
	...
	<div style="text-align: center; padding: 5px">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			...
			class="easyui-linkbutton" onclick="javascript:clearForm()">重置</a>
	</div>
