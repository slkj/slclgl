...
<body>
	<div class="easyui-panel" style="padding: 5px">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			onclick="javascript:update()" data-options="iconCls:'icon-save'">保存</a>
		<a href="javascript:void(0)" class="easyui-linkbutton"
			...
			<table class="grid">
				...
				<tr>
					...
					<td>长<input id="carContLength" name="carContLength"
						...
						name="carContHeight" class="easyui-numberbox" style="width: 70px;"
	...
	<div>
		...
		<form name="cForm" action="/springMVC7/file/upload2"
			...
			<ul style="padding-top: 0px; padding-bottom: 5px;">
				<li>车辆登记证上传： <input type="file" id="djFile" name="myfiles" size="28" accept="image/jpeg,image/png,image/gif,image/jpeg" /></li>
				<li>车辆合格证/行驶证： <input type="file" id="xsFile" name="myfiles" size="28" accept="image/jpeg,image/png,image/gif,image/jpeg" /></li>
				<li>车身照片： <input type="file" id="carimg" name="myfiles" size="28" accept="image/jpeg,image/png,image/gif,image/jpeg" /></li>
			</ul>
		</form>
	</div>
